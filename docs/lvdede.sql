...
(1, 10, 'admin', 'f297a57a5a743894a0e4', 'admin', '', '', '0', 1368926685, '127.0.0.1');
...
(12, 0, 0, 999, '在线留言', 'http://c.lvren.com/plus/guestbook.php', 1, 'guestbook.php', 0, 1, -1, 2, 0, '', '', '', '', '', 'default', '', '', '', 0, '', '', 0, 0, '0', '', NULL),
(13, 0, 0, 990, '小说', 'http://c.lvren.com/book', 1, 'index.php', 0, 1, -1, 2, 0, '', '', '', '', '', 'default', '', '', '', 0, '', '', 0, 0, '0', '', NULL),
(14, 0, 0, 995, '黄页', 'http://c.lvren.com/company', 1, 'index.php', 0, 1, -1, 2, 0, '', '', '', '', '', 'default', '', '', '', 0, '', '', 0, 0, '0', '', NULL),
(15, 0, 0, 992, '问答', 'http://c.lvren.com/ask', 1, 'index.php', 0, 1, -1, 2, 0, '', '', '', '', '', 'default', '', '', '', 0, '', '', 0, 0, '0', '', NULL),
(16, 0, 0, 991, '圈子', 'http://c.lvren.com/group', 1, 'index.php', 0, 1, -1, 2, 0, '', '', '', '', '', 'default', '', '', '', 0, '', '', 0, 0, '0', '', NULL);
...
CREATE TABLE IF NOT EXISTS `dede_ask` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dede_askanswer` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dede_asktype` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `dede_ask_scores`
--

CREATE TABLE IF NOT EXISTS `dede_ask_scores` (
  `mid` int(11) NOT NULL,
...
(4, 1, '网页基础-Dreamweaver', 'gb2312', 1368932541, 1270604357, 0, 1, 0, '{dede:noteinfo notename="网页基础-Dreamweaver" channelid="1" macthtype="string"\r\n    refurl="http://" sourcelang="gb2312" cosort="asc"\r\n  isref="no" exptime="10" usemore="0" /}\r\n{dede:listrule sourcetype="batch" rssurl="http://" regxurl="http://www.dedecms.com/knowledge/web-based/dreamweaver/list_47_(*).html"\r\nstartid="1" endid="2" addv="1" urlrule="area" musthas="/knowledge/web-based/"\r\n nothas="" listpic="1" usemore="0"}\r\n    {dede:addurls}{/dede:addurls}\r\n    {dede:batchrule}{/dede:batchrule}\r\n    {dede:regxrule}{/dede:regxrule}\r\n    {dede:areastart}<!--没有下一页-->\r\n</div>\r\n</div>{/dede:areastart}\r\n    {dede:areaend}<div class="pagination">{/dede:areaend}\r\n{/dede:listrule}\r\n', '{dede:sppage sptype=''full'' srul=''1'' erul=''5''}<div class="pagebreak">[内容]</div>{/dede:sppage}\r\n{dede:previewurl}http://www.dedecms.com/knowledge/web-based/html/2009/0929/880.html{/dede:previewurl}\r\n{dede:keywordtrim}{/dede:keywordtrim}\r\n{dede:descriptiontrim}{/dede:descriptiontrim}\r\n{dede:item field=''title'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}<title>[内容]_织梦CMS</title>{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''writer'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''source'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''pubdate'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''body'' value='''' isunit=''1'' isdown=''1''}\r\n   {dede:match}<div class="content">[内容]<div class="pagebreak">{/dede:match}\r\n   {dede:trim replace=""}<a([^>]*)>(.*)</a>{/dede:trim}\r\n{dede:trim replace=""}<script([^>]*)>(.*)</script>{/dede:trim}\r\n{dede:trim replace=""}<!--(.*)-->{/dede:trim}\r\n{dede:trim replace=""}<object([^>]*)>(.*)</object>{/dede:trim}\r\n{dede:trim replace=""}<div([^.]*)>{/dede:trim}\r\n{dede:trim replace=""}</div>{/dede:trim}\r\n   {dede:function}{/dede:function}\r\n{/dede:item}'),
(5, 6, '天猫商品采集', 'gb2312', 1368959311, 0, 0, 1, 0, '{dede:noteinfo notename="天猫商品采集" channelid="6" macthtype="string"\r\n    refurl="http://detail.tmall.com/item.htm?spm=a1z10.3.w17-737739803.11.Ti4BjM&id=21578412784&" sourcelang="gb2312" cosort="asc"\r\n  isref="yes" exptime="10" usemore="0" /}\r\n{dede:listrule sourcetype="batch" rssurl="http://" regxurl="http://lcly.tmall.com/search.htm?spm=a1z10.3.w17-737739803.65.xM1vxS&search=y&viewType=list&orderType=newOn&pageNum=(*)"\r\nstartid="1" endid="7" addv="1" urlrule="area" musthas=""\r\n nothas="show_review" listpic="1" usemore="0"}\r\n    {dede:addurls}{/dede:addurls}\r\n    {dede:batchrule}{/dede:batchrule}\r\n    {dede:regxrule}{/dede:regxrule}\r\n    {dede:areastart}<ul class="shop-list">{/dede:areastart}\r\n    {dede:areaend}<div class="pagination">{/dede:areaend}\r\n{/dede:listrule}\r\n', '{dede:sppage sptype=''full'' srul=''1'' erul=''5''}{/dede:sppage}\r\n{dede:previewurl}http://detail.tmall.com/item.htm?spm=a1z10.3.w17-737739803.11.Ti4BjM&id=21578412784&{/dede:previewurl}\r\n{dede:keywordtrim}{/dede:keywordtrim}\r\n{dede:descriptiontrim}{/dede:descriptiontrim}\r\n{dede:item field=''title'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}<title>[内容]</title>{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''writer'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''source'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''pubdate'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''body'' value='''' isunit=''1'' isdown=''1''}\r\n   {dede:match}<title>[内容]</title>{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''price'' value=''0'' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''trueprice'' value=''0'' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''brand'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''units'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''vocation'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''infotype'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''uptime'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}'),
(6, 1, '天猫商品采集2', 'gb2312', 1368957970, 0, 0, 1, 0, '{dede:noteinfo notename="天猫商品采集2" channelid="1" macthtype="string"\r\n    refurl="http://detail.tmall.com/item.htm?spm=a1z10.3.w17-737739803.11.acKglD&id=21578412784&" sourcelang="gb2312" cosort="asc"\r\n  isref="no" exptime="10" usemore="0" /}\r\n{dede:listrule sourcetype="batch" rssurl="http://" regxurl="http://lcly.tmall.com/search.htm?search=y&viewType=list&orderType=newOn&pageNum=(*)"\r\nstartid="1" endid="10" addv="1" urlrule="area" musthas=""\r\n nothas="" listpic="1" usemore="0"}\r\n    {dede:addurls}{/dede:addurls}\r\n    {dede:batchrule}{/dede:batchrule}\r\n    {dede:regxrule}{/dede:regxrule}\r\n    {dede:areastart}<ul class="shop-list">{/dede:areastart}\r\n    {dede:areaend}div class="pagination">{/dede:areaend}\r\n{/dede:listrule}\r\n', '{dede:sppage sptype=''full'' srul=''1'' erul=''5''}{/dede:sppage}\r\n{dede:previewurl}http://detail.tmall.com/item.htm?spm=a1z10.3.w17-737739803.11.nTi4WG&id=24926488374&{/dede:previewurl}\r\n{dede:keywordtrim}{/dede:keywordtrim}\r\n{dede:descriptiontrim}{/dede:descriptiontrim}\r\n{dede:item field=''title'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}<title>[内容]</title>{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''writer'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''source'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''pubdate'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''body'' value='''' isunit=''1'' isdown=''1''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}'),
(8, 1, '天猫商品3', 'gb2312', 1368958527, 0, 0, 1, 0, '{dede:noteinfo notename="天猫商品3" channelid="1" macthtype="string"\r\nrefurl="http://detail.tmall.com/item.htm?spm=a1z10.3.w17-737739803.11.Ti4BjM&id=21578412784&" sourcelang="gb2312" cosort="asc" isref="no" exptime="10" usemore="0" /}\r\n\r\n{dede:listrule sourcetype="batch" rssurl="http://" regxurl="http://lcly.tmall.com/search.htm?spm=a1z10.3.w17-737739803.65.EeVeqr&search=y&viewType=list&orderType=newOn&pageNum=(*)#anchor"\r\nstartid="1" endid="7" addv="1" urlrule="area"\r\n musthas="" nothas="" listpic="1" usemore="0"}\r\n    {dede:addurls}{/dede:addurls}\r\n    {dede:batchrule}{/dede:batchrule}\r\n    {dede:regxrule}{/dede:regxrule}\r\n    {dede:areastart}<!--下一页-->{/dede:areastart}\r\n    {dede:areaend}<div class="pagination">{/dede:areaend}\r\n{/dede:listrule}\r\n', '{dede:sppage sptype=''full'' sptype=''full'' srul=''1'' erul=''5''}{/dede:sppage}\r\n{dede:previewurl}http://detail.tmall.com/item.htm?id=21578412784&{/dede:previewurl}\r\n{dede:keywordtrim}{/dede:keywordtrim}\r\n{dede:descriptiontrim}{/dede:descriptiontrim}\r\n{dede:item field=''title'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}<title>[内容]</title>{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}\r\n{dede:item field=''writer'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}\r\n{dede:item field=''source'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}\r\n{dede:item field=''pubdate'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}@me=GetMkTime(@me);{/dede:function}\r\n{/dede:item}\r\n{dede:item field=''body'' value='''' isunit=''1'' isdown=''1''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}\r\n'),
(7, 1, 'yahoo人', 'utf-8', 1368956536, 0, 0, 1, 0, '{dede:noteinfo notename="yahoo人" channelid="1" macthtype="string"\r\n    refurl="http://soul.cn.yahoo.com/ypen/20130320/1667419.html" sourcelang="utf-8" cosort="asc"\r\n  isref="no" exptime="10" usemore="0" /}\r\n{dede:listrule sourcetype="batch" rssurl="http://" regxurl="http://soul.cn.yahoo.com/ren/index.html?page=(*)"\r\nstartid="1" endid="19" addv="1" urlrule="area" musthas=""\r\n nothas="" listpic="1" usemore="0"}\r\n    {dede:addurls}{/dede:addurls}\r\n    {dede:batchrule}{/dede:batchrule}\r\n    {dede:regxrule}{/dede:regxrule}\r\n    {dede:areastart}<h2>往期回顾</h2>{/dede:areastart}\r\n    {dede:areaend}<div class="y_page">{/dede:areaend}\r\n{/dede:listrule}\r\n', '{dede:sppage sptype=''full'' srul=''1'' erul=''5''}{/dede:sppage}\r\n{dede:previewurl}http://soul.cn.yahoo.com/ypen/20130320/1667419.html{/dede:previewurl}\r\n{dede:keywordtrim}{/dede:keywordtrim}\r\n{dede:descriptiontrim}{/dede:descriptiontrim}\r\n{dede:item field=''title'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}<title>[内容]</title>{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''writer'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''source'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''pubdate'' value='''' isunit='''' isdown=''''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}{dede:item field=''body'' value='''' isunit=''1'' isdown=''1''}\r\n   {dede:match}{/dede:match}\r\n   \r\n   {dede:function}{/dede:function}\r\n{/dede:item}');
...
CREATE TABLE IF NOT EXISTS `dede_groups` (
...
--
-- 表的结构 `dede_group_guestbook`
--

CREATE TABLE IF NOT EXISTS `dede_group_guestbook` (
...
--
-- 表的结构 `dede_group_notice`
--

CREATE TABLE IF NOT EXISTS `dede_group_notice` (
...
--
-- 表的结构 `dede_group_posts`
--

CREATE TABLE IF NOT EXISTS `dede_group_posts` (
...
--
-- 表的结构 `dede_group_smalltypes`
--

CREATE TABLE IF NOT EXISTS `dede_group_smalltypes` (
  `id` smallint(6) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `dede_group_threads`
--

CREATE TABLE IF NOT EXISTS `dede_group_threads` (
...
--
-- 表的结构 `dede_group_user`
--

CREATE TABLE IF NOT EXISTS `dede_group_user` (
...
--
-- 表的结构 `dede_mail_order`
--

CREATE TABLE IF NOT EXISTS `dede_mail_order` (
...
--
-- 表的结构 `dede_mail_title`
--

CREATE TABLE IF NOT EXISTS `dede_mail_title` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
  `period` int(10) NOT NULL,
  `typeid` smallint(5) NOT NULL,
  `title` char(200) CHARACTER SET gbk NOT NULL,
  `content` mediumtext CHARACTER SET gbk NOT NULL,
  `addtime` int(10) NOT NULL,
  `sendtime` int(10) NOT NULL,
  `writer` char(20) CHARACTER SET gbk NOT NULL,
  `mid` mediumint(8) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dede_mail_type` (
  `id` smallint(5) NOT NULL AUTO_INCREMENT,
  `typename` char(60) CHARACTER SET gbk NOT NULL,
...
(1, '个人', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', '男', 100, 0, 0, 0, '', 10000, 10, 0, '', 0, '', 1368926656, '', 1368926685, '127.0.0.1', -1),
...
(45, '站内新闻发布', '<m:item name=''站内新闻发布'' link=''mynews_main.php'' rank=''plus_站内新闻发布'' target=''main'' />', '', '织梦团队', 1, ''),
(46, '邮件订阅', '<m:item name=''邮件订阅'' link=''mail_send.php'' rank=''plus_Mail'' target=''main'' />', '', '织梦团队', 1, '');
...
--
-- 表的结构 `dede_store_groups`
--

CREATE TABLE IF NOT EXISTS `dede_store_groups` (
...
(1, 'cfg_basehost', '站点根网址', 1, 'string', 'http://c.lvren.com'),
(2, 'cfg_cmspath', 'DedeCMS安装目录', 2, 'string', ''),
(3, 'cfg_cookie_encode', 'cookie加密码', 2, 'string', 'OuVKv4428D'),
...
(701, 'cfg_book_freenum', '连载内容默认免费章节(-1为全开放)', 8, 'string', '6'),
...
(200, 'cfg_ask', '是否启用问答模块', 8, 'bool', 'Y'),
(201, 'cfg_ask_isdomain', '是否启用二级域名(启用需要设置 跨域共享cookie的域名)', 8, 'bool', 'N'),
(202, 'cfg_ask_domain', '问答模块的二级域名(例如:http://ask.dedecms.com)', 8, 'string', ''),
(203, 'cfg_ask_sitename', '问答系统名称', 8, 'string', '织梦问答'),
(204, 'cfg_ask_directory', '问答的目录名称', 8, 'string', '/ask'),
(205, 'cfg_ask_rewrite', '是否使用Rewrite', 8, 'bool', 'N'),
(206, 'cfg_ask_ifcheck', '问答模块提问是否需要审核', 8, 'bool', 'N'),
(207, 'cfg_ask_dateformat', '问答模块日期格式', 8, 'string', 'Y-n-j'),
(208, 'cfg_ask_timeformat', '问答模块时间格式', 8, 'string', 'H:i'),
(209, 'cfg_ask_timeoffset', '问答模块时区设定', 8, 'string', '8'),
(210, 'cfg_ask_gzipcompress', '是否启用gzip压缩', 8, 'string', '1'),
(211, 'cfg_ask_cookiepre', '问答模块cookie前缀', 8, 'string', 'deask_'),
(212, 'cfg_ask_ifkey', '问答模块回答问题是否需要审核', 8, 'bool', 'N'),
(213, 'cfg_ask_expiredtime', '问答模块问题有效期（天）', 8, 'string', '20'),
(214, 'cfg_ask_tpp', '问答模块列表显示问题数', 8, 'string', '14'),
(215, 'cfg_ask_symbols', '问答模块导航间隔符', 8, 'string', '>'),
(216, 'cfg_ask_ifanscore', ' 是否开启回答问题增加积分', 8, 'bool', 'Y'),
(217, 'cfg_ask_answerscore', ' 会员回答问题就增加积分', 8, 'string', '2'),
(218, 'cfg_ask_bestanswer', '最佳答案系统奖励积分', 8, 'string', '20'),
(219, 'cfg_ask_subtypenum', '首页显示子类数据', 8, 'string', '10'),
(220, 'cfg_ask_anscore', '匿名提问需要花费的积分数', 8, 'string', '10'),
(221, 'gdfaq_ask', '问答是否开启验证问题', 8, 'bool', 'Y'),
(222, 'cfg_ask_guestview', '问答是否允许游客访问', 0, 'bool', '8'),
(223, 'cfg_ask_guestanswer', '问答是否允许匿名回复问题', 0, 'bool', '8'),
(301, 'cfg_group_creators', '圈子模块,要达多该积分数才可以创建圈子', 8, 'string', '1000'),
(302, 'cfg_group_max', '用户最多可圈子数量,0不限制.', 8, 'string', '0'),
(303, 'cfg_group_maxuser', '圈子可接受用户数量,0不限制', 8, 'string', '0'),
(304, 'cfg_group_click', '加入圈子用户是否审核,0不;1要', 8, 'string', '1'),
(305, 'cfg_group_words', '圈子一贴子可发字符数', 8, 'string', '1000'),
(755, 'cfg_checkemail', '开启邮件订阅时进行邮箱审核', 8, 'bool', 'Y');
...
(9, '7badb72a3ff79af2a7112beee60cb970', '小说模块', '小说', '../book/mybooks.php', 1, '              <m:top name=''小说管理'' display=''block'' c=''6,'' rank=''''>\r\n	          <m:item name=''小说栏目管理'' link=''story_catalog.php'' rank=''story_catalog'' target=''main'' />\r\n	          <m:item name=''小说书目'' link=''story_books.php'' rank=''story_list'' target=''main'' />\r\n	          <m:item name=''小说连载内容'' link=''story_list_content.php'' rank=''story_list'' target=''main'' />\r\n	          <m:item name=''小说章节管理'' link=''story_list_chapter.php'' rank=''story_list'' target=''main'' />\r\n	          <m:item name=''更新小说HTML'' link=''makehtml_story.php'' rank=''sys_MakeHtml'' target=''main'' />\r\n                  <m:item name=''评论管理'' link=''story_feedback_main.php'' rank=''sys_MakeHtml'' target=''main'' />\r\n	      </m:top>'),
(10, '867af26e9c1ccf22a1cf67e756cf5acc', '黄页模块', '', '', 0, ''),
(11, '8964eda9013d1df0afea08ed63243436', '站内新闻', '', '', 0, ''),
(12, 'be722dbfa3cb3cb5628aab2d767ff62e', '问答模块', '问答', '../ask/?ct**myask', 1, '<m:top name=''问答管理'' c=''6,'' display=''block'' rank=''''>\r\n  <m:item name=''栏目管理'' link=''../ask/admin.php?ct=asktype'' rank='''' target=''main'' />\r\n  <m:item name=''问题管理'' link=''../ask/admin.php?ct=issue'' rank='''' target=''main'' />\r\n  <m:item name=''答案管理'' link=''../ask/admin.php?ct=answer'' rank='''' target=''main'' />\r\n  <m:item name=''幻灯片管理'' link=''../ask/admin.php?ct=slide'' rank='''' target=''main'' />\r\n</m:top>'),
(13, 'dfcb5cd4d7bc0e3f7eb655e62dd6bc64', '圈子模块', '圈子', '../group/mygroup.php', 1, '<m:top name=''圈子管理'' c=''6,'' display=''block''>\r\n<m:item name=''分类设置'' link=''group_store.php'' rank=''group_All'' target=''main''/>\r\n<m:item name=''圈子列表'' link=''group_main.php'' rank=''group_All'' target=''main''/>\r\n<m:item name=''主题管理'' link=''group_threads.php'' rank=''group_All'' target=''main''/>\r\n</m:top>'),
(14, 'c10bb6ac52082ab3e669b4814b44a6f1', '邮件订阅', '邮件订阅', '../member/mail.php', 1, '<m:top name=''邮件订阅'' c=''6,'' display=''block'' rank=''plus_Mail''>\r\n  <m:item name=''会员邮件管理'' link=''mail_send.php'' rank=''plus_Mail'' target=''main'' />\r\n  <m:item name=''订阅期刊管理'' link=''mail_title.php'' rank=''plus_Mail'' target=''main'' />\r\n  <m:item name=''订阅分类管理'' link=''mail_type.php'' rank=''plus_Mail'' target=''main'' />\r\n  <m:item name=''群发期刊管理'' link=''mail_title_send.php'' rank=''plus_Mail'' target=''main'' />\r\n  <m:item name=''获取邮件地址'' link=''mail_getfile.php'' rank=''plus_Mail'' target=''main'' />、\r\n  <m:item name=''邮件列表管理'' link=''mail_file_manage.php'' rank=''plus_Mail'' target=''main'' />\r\n</m:top>');
...
(1, '你是从哪儿得知本站的？', 1266336000, 1584547200, 1, 0, 1, 1, 0, 0, '<v:note id=''1'' count=''2''>朋友介绍</v:note>\r\n<v:note id=''2'' count=''0''>门户网站的搜索引擎</v:note>\r\n<v:note id=''3'' count=''2''>Google或百度搜索</v:note>\r\n<v:note id=''4'' count=''2''>别的网站上的链接</v:note>\r\n<v:note id=''5'' count=''1''>其它途径</v:note>\r\n');
